...
class TransunionApiWebClientTest {

    @Test
    void inquireCreditScory_success() {
        ExchangeFunction exchangeFunction = mock(ExchangeFunction.class);
        WebClient webClient = WebClient.builder().exchangeFunction(exchangeFunction).build();
        TransunionApiWebClient transunionApiWebClient= new TransunionApiWebClient(webClient);
        ...
        Mono<Integer> responseMono = transunionApiWebClient.inquireCreditScory(request);
        StepVerifier
                .create(responseMono)
                .expectNextCount(1)
                .expectComplete()
